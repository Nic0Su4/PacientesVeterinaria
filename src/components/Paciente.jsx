  ...
  return (
	<div className='m-3 bg-white shadow-md px-5 py-10 rounded-xl mx-5 my-10'>
		...
		<div className="flex justify-between mt-8">
			<button
				type="button"
				className="py-2 px-6 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-md uppercase"
			...
			<button
				type="button"
				className="py-2 px-6 bg-red-600 hover:bg-red-700 text-white font-bold rounded-md uppercase"
